...
module Casein
  class EventsController < Casein::CaseinController
    ...
    private
      ...
      def event_params
        params.require(:event).permit(:name, :details, :image, :image_cache, :_destroy, :remove_image, :event_status, sessions_attributes: [:id, :event_id, :_destroy, :start_date, :end_date, :start_time, :duration, :booking_link, :session_details, :venue, :street, :city, :state, :postcode, :country])
      end
  end
end
