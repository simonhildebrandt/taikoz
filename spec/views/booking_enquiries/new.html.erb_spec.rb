...
RSpec.describe "booking_enquiries/new", type: :view do
  before(:each) do
    assign(:booking_enquiry, BookingEnquiry.new(
      :first_name => "MyString",
      :last_name => "MyString",
      :phone => "MyString",
      :email => "MyString",
  ...
  it "renders new booking_enquiry form" do
    render

    assert_select "form[action=?][method=?]", booking_enquiries_path, "post" do
